  ...
  return (
    <div className="parent">
      {jobOpenings.map(function(elem){
        ...
        return <Card company={elem.companyName} pay={elem.pay} logo={elem.brandLogo} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} location={elem.location} />
      })}
    </div>
  )
}
