    ...
    <>
      ...
      {popup && (
        <div className="absolute top-0 left-0 w-screen h-screen bg-[#121212] flex justify-center items-center">
          <button onClick={()=>{setPopup(false)}} className="rounded-2xl hover:opacity-70 border-2 border-double text-[tomato] p-4 text-center absolute top-[1rem] right-[1rem]">❌</button>
