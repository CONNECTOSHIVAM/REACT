...
const TodoCard = ({todo}) => {
  return (
  <div className=" p-5 flex justify-between items-center mt-5 rounded-xl opacity-80 outline-1 outline-amber-400">
    <div className="w-[60%]">
      <h1 className="text-2xl font-semibold mb-2 text-amber-900">{todo.title}</h1>
